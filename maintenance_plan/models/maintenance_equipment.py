...
class MaintenanceEquipment(models.Model):
    ...
    def _create_new_request(self, maintenance_plan):
        ...
        horizon_date = fields.Datetime.from_string(fields.Datetime.today()) + maintenance_plan.get_relativedelta(maintenance_plan.maintenance_plan_horizon, maintenance_plan.planning_step)
